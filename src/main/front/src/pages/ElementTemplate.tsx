      ...
      <Tabs defaultActiveKey="general">
        <Tab eventKey="general" title="General">
          <InputGroup className="mb-3">
            ...
            <Form.Control aria-label="Name" readOnly={user.profile != 'Admin'} value={templateValue.name} onChange={(evt) => update('name', evt.target.value)} />
          </InputGroup>
          <InputGroup className="mb-3">
            <InputGroup.Text>Type</InputGroup.Text>
            <Form.Control aria-label="Type" readOnly={user.profile != 'Admin'} value={templateValue.properties[0].value} onChange={(evt) => updateJobType(evt.target.value)} />
          </InputGroup>
          <InputGroup className="mb-3">
